...
def run_method_folder():
    ...
    for method in method_list:
        for folder in folder_list:
            ...
            test_data_list = []
            for i in range(1, 6):
                train_data_list.append(f'data/reduced_data_made/{method}/{folder}/folder_{i}/train_dataset')
                test_data_list.append(f'data/reduced_data_made/{method}/{folder}/folder_{i}/test_dataset')
